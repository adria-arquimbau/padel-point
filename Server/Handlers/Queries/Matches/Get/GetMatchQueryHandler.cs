    ...
    public async Task<MatchResponse> Handle(GetMatchQueryRequest request, CancellationToken cancellationToken)
    {
        ...
        var match = await _context.Match
            ...
            .Select(x => new MatchResponse
            {
                ...
                TournamentImageUri = x.Tournament.ImageUri,
                TournamentPhase = x.RobinPhaseGroup != null ? "Round Robin Phase" : "-",
                TournamentRound = x.RobinPhaseRound != null ? $"Round {x.RobinPhaseRound}" : "-",
